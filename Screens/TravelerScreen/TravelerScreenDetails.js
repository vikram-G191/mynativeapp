...
//     GetTBSSeatConfirmed,
//     TBS_Booking_Details,
// } from '../API/TBSapi/DashBoard/Dashboard';
...
//     const themeheaderFontColor1 =
//         screenTheme === 'Luxury Coach' ? '#141414' : 'rgba(255, 255, 255, 0.5)'; // Default to black if not '#393939'
//     const {
...
//     console.log(selectedBusData, 'selectedlog');
...
//     const [confirmRefNo, setConfirmRefNo] = useState("");
...
//         console.log(seat, field, value, "AAAAAAAAAAAAAAAAAAAAAAAA")
...
//         console.log('Praveenzzzzzzzzzzzz')
//         try {
...
//                 totalPrice,
//             );
//             console.log(response, 'GetTBSSeatBlock');
//             if (response?.status === 'success') {
//                 console.log("i am insideeee");
//                 setNewRefNo(response?.ReferenceNo)
//                 // setConfirmModal(true);
//                 // setEnableInput(true);
//                 setConfirmRefNo(response?.ReferenceNo);
//                 // await AsyncStorage.setItem('key', JSON.stringify(response?.ReferenceNo));
//                 // try {
...
//                 //     // );
//                 console.log(response, 'responseGetTBS')
//                 const data = await GetTBSFareInfo(
//                     adultCount,
//                     childCount,
//                     response?.ReferenceNo,
//                 );
//                 console.log(data, adultCount, childCount, "adultCount_childcount")
//                 setFareDetails(data?.GetFaresInfo);
//                 // if(confirmRefNo?.length > 0){
//                 RazorpayGateway();
//                 // AsyncStorage.setItem("reference",response?.ReferenceNo)

//                 // }
//                 // } catch { }
//                 await AsyncStorage.setItem("reference", response?.ReferenceNo);
//             }
//             console.log(response, '|------------|', 'seatblocking');
//         } catch (error) {
...
//         }
//     };
// console.log(AsyncStorage.getItem("reference"),"refnononononno4545454545")
// const getData = async () => {
//     try {
//       const reference = await AsyncStorage.getItem("reference");
//       console.log(reference, "refnononononno");
//     } catch (e) {
...
//             const response = await GetTBSSeatConfirmed(selectedBusData, confirmRefNo,newRefNo);
//             // console.log(selectedBusData, "selectedBusData")
//             console.log(response, confirmRefNo,newRefNo, "confirmRefNo")
//             if (response?.status === 'success') {
//                 // toast.success(
...
//                 const ticketdetails = await GetViewTicketID(response?.TicketNo);
...
//                 console.log(ticketdetails,response?.TicketNo, "ticketdetails")
...
//     const totaltax =
//         seatTaxList?.length > 0 && seatTaxList.reduce((a, b) => a + b, 0); // Sum up the tax values
...
//         state => state?.productReducer?.discount_offer_list,
//     );
...
//         console.log("amountttt", tbsamount);
...
//                 <Image
//                     source={{
//                         uri: `${api_crm_image}${image?.theme ? image?.theme : image?.background_image
//                             }`,
//                     }}
//                     style={{ height: 100, width: 185, borderRadius: 8 }}
//                 />
//                 {console.log(
//                     `${api_crm_image}${image?.theme ? image?.theme : image?.background_image
//                     }`,
//                     'prafbnwe',
//                 )}
...
//         setPromoCode(values);
//         try {
//             const response = await GetOfferValid(emailInput, mobileInput, values);
...
//                 flex: 1,
//                 backgroundColor:
//                     screenTheme === 'Luxury Coach' ? '#F6B642' : themecolor,
//             }}
//             edges={['right', 'left', 'top']}>
//             {
//                 ticketLoader === true ?
//                     <View style={{ height: "100%", width: "100%", backgroundColor: "white", flexDirection: "column", justifyContent: "center", alignItems: "center" }}><FastImage style={{ height: 300, width: 350, }} source={require("../assets/Loader/bus.gif")} resizeMode="contain"></FastImage></View>
//                     :
...
//                                     </Text>
//                                     <Text
//                                         style={[styles.topSubtitle, { color: themeheaderFontColor1 }]}>
//                                         Step 3 of 4
//                                     </Text>
//                                 </View>
//                             </View>
...
//                                 mobile: mobileInput ? mobileInput : '',
//                                 name: '',
//                                 age: '',
//                                 gender: '',
...
//                                                             paddingTop: 14,
//                                                         },
//                                                         isJourneyExpand === false && {
//                                                             height: 60,
//                                                             paddingTop: 0,
//                                                         },
//                                                     ]}
//                                                     onPress={() => {
//                                                         setJourneyExpand(!isJourneyExpand);
//                                                     }}>
//                                                     <Text
//                                                         style={{
//                                                             fontWeight: '500',
...
//                                                                                 lineHeight: 14,
//                                                                             }}>
//                                                                             {Formatting(selectedBusData?.BUS_START_DATE)}
//                                                                         </Text>
//                                                                         <Text
//                                                                             style={{
//                                                                                 fontSize: 12,
...
//                                                                                     lineHeight: 11,
//                                                                                 }}>
//                                                                                 {selectedBusData?.TravelTime.split(':')
//                                                                                     .slice(0, 2)
//                                                                                     .join(':')}{' '}
//                                                                                 Hrs
//                                                                             </Text>
...
//                                                                                 lineHeight: 14,
//                                                                             }}>
//                                                                             {Formatting(selectedBusData?.jdate)}
//                                                                         </Text>
//                                                                         <Text
//                                                                             style={{
//                                                                                 fontSize: 12,
...
//                                                             style={[
//                                                                 styles.textInput,
//                                                                 { marginTop: 10, marginLeft: 5, marginRight: 10 },
//                                                             ]}
...
//                                                             }}>
//                                                             <View
//                                                                 style={{ flex: 1, marginTop: 10, marginRight: 5 }}>
//                                                                 <TextInput
...
//                                                                             style={[
//                                                                                 styles.input,
//                                                                                 touched.passengers?.[seat]?.name &&
//                                                                                     errors.passengers?.[seat]?.name
//                                                                                     ? styles.errorInput
//                                                                                     : null,
//                                                                             ]}
...
//                                                                             style={[
//                                                                                 styles.input,
//                                                                                 touched.passengers?.[seat]?.age &&
//                                                                                     errors.passengers?.[seat]?.age
//                                                                                     ? styles.errorInput
//                                                                                     : null,
//                                                                             ]}
...
//                                                                                 style={[
//                                                                                     styles.genderButton,
//                                                                                     values.passengers[seat].gender ===
//                                                                                     'male' && styles.selectedGenderButton,
//                                                                                 ]}
//                                                                                 onPress={() => {
...
//                                                                                         values.passengers[seat].gender ===
//                                                                                         'male' && styles.selectedGenderText,
//                                                                                     ]}>
//                                                                                     Male
//                                                                                 </Text>
//                                                                             </TouchableOpacity>
...
//                                                                                     styles.genderButton,
//                                                                                     values.passengers[seat].gender ===
//                                                                                     'female' && styles.selectedGenderButton,
//                                                                                 ]}
//                                                                                 onPress={() => {
...
//                                                                                         styles.genderButtonText,
//                                                                                         values.passengers[seat].gender ===
//                                                                                         'female' && styles.selectedGenderText,
//                                                                                     ]}>
//                                                                                     Female
//                                                                                 </Text>
//                                                                             </TouchableOpacity>
//                                                                         </View>
//                                                                         {touched.passengers?.[seat]?.gender &&
//                                                                             errors.passengers?.[seat]?.gender && (
//                                                                                 <Text style={styles.error}>
//                                                                                     {errors.passengers[seat].gender}
//                                                                                 </Text>
//                                                                             )}
...
//                                                                                 if (mobileInput === '') {
//                                                                                     alert(
//                                                                                         'Please enter your mobile number and E-mail.',
//                                                                                     );
//                                                                                 } else {
//                                                                                     //    handleOfferValid
...
//                                                                                 useAngle={true}
//                                                                                 angle={
//                                                                                     screenTheme === 'Luxury Coach' ? 150 : 45
//                                                                                 }
//                                                                                 style={[
//                                                                                     {
//                                                                                         justifyContent: 'center',
...
//                                                 borderRadius: 10,
//                                                 borderColor:
//                                                     screenTheme === 'Luxury Coach' ? '#D89E2F' : themecolor,
//                                             }}>
//                                             {/* {confirmRefNo?.length > 0 ? */}
//                                             <View
//                                                 style={{
...
//                                                                 }}>
//                                                                 {`- ₹ ${Math?.round(
//                                                                     Number(totalPrice) * Number(tbs_discount / 100),
//                                                                 )}`}
//                                                             </Text>
//                                                         </View>
...
const TravelerScreenDetails = ({ props, navigation, route }) => {
  // const api_crm_image = REACT_APP_CRM_API_URL_IMAGE
  // const api_crm_image = `https://crm.thebusstand.com`;

  const api_crm_image = process.env.REACT_APP_CRM_API_URL_IMAGE
  ...
  console.log(Journey_Details, "total_Price")
  // Mapping the seatNumber from the selectedSeats array
  const seatNumbers = selectedSeat.map(seat => seat.seatNumber);
  ...
  const [isJourneyExpand, setJourneyExpand] = useState(true);
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      getName().then((name) => {
        setUserName(name);
        console.log("User_name_refferal", name);
      });
      getEmail().then((mail) => {
        setUserMail(mail);
        console.log("User_mail_refferal", mail);
      });
      getPhone().then((num) => {
        setUserPhone(num);
        console.log("User_num_refferal", num);
      });
  ...
  const [passengerData, setPassengerData] = useState(
    Object.keys(selectedSeat).reduce((acc, seat) => {
      acc[seat] = { name: '', age: '', gender: '', seat: selectedSeat[seat].seatNumber };
      return acc;
    }, {}),
  );

  // const [passengerData, setPassengerData] = useState(
  //   selectedSeat.reduce((acc, seat) => {
  //     acc[seat.seatNumber] = { name: '', age: '', gender: '', seat: seat.seatNumber };
  //     return acc;
  //   }, {})
  // );
      ...
      Object.keys(selectedSeat).reduce((acc, seat) => {
        acc[seat] = Yup.object().shape({
          name: Yup.string()
            ...
            .min(3, 'Minimum three letters are required')
  ...
  // const newArrival = (departureDate, departureTime, durationStr) => {
  //     const departureDateTime = dayjs(`${departureDate} ${departureTime}`, "YYYY-MM-DD hh:mm A");

  //     // Parse the duration string into a Day.js duration object
  ...
  //     // Add the duration to the departure time
  //     const arrivalDateTime = departureDateTime.add(durationObj);
  ...
  const [billingAddress, setBillingAddress] = useState({
    address: selectedBoardingPoint?.landmark,
    pincode: '',
    state: Journey_Details?.from_state || Journey_Details?.arrival_state_name,
    city: Journey_Details?.from_station_name || Journey_Details?.from,
  });
  // console.log(billingAddress, "billingAddress")
  // Function to handle input changes
  const handleBillingAddress = (field, value) => {
  ...
  console.log(faredetails, "getPassengerCount")
  ...
  const handleSubmit = async values => {
    ...
    try {
      ...
      // console.log(response, selectedSeat, "responcesubmit");
  ...
  const [promoCode, setPromoCode] = useState('');
  console.log(promoCode, 'promocodee');
  ...
  const tbsdeal = (Number(totalPrice) * Number(tbs_discount / 100)).toFixed(2);

  console.log(tbsdeal, "tbs__deal")

  const tbsFare = (totalPrice - tbsdeal).toFixed(2);

  console.log(tbsFare, 'tbs__fare')

  const tbsTotalTax = ((tbsFare * 5) / 100).toFixed(2);

  console.log(tbsTotalTax, 'tbs_Total_Tax')

  const handleBookingPrice = async (order_id, payment_id, signature, msg) => {
    // setTicketLoading(true);
    // console.log(order_id, "order_id")
    // console.log(confirmRefNo, "refnonononon");
    ...
    try {
      ...
      // console.log(selectedBusData, "selectedBusData")
      console.log(response, "confirmRefNoresponse")
      if (response?.status === 'success') {
        // toast.success(
        //   `Ticket Booked Successfully, your TicketNo: ${response?.TicketNo}`
        // );
        ...
        // );
        // console.log(response?.TicketNo, "ticketnumberesponse")
        const ticketdetails = await GetViewTicketID(response?.TicketNo, dispatch);
        // const ticketservices = await GetTBSService(response?.TicketNo);
        const values = {
          ticketNumber: response?.TicketNo,
        };
        ...
        const update = await TBSBookingStatusUpdate(
          confirmRefNo,
          response?.TicketNo
        );
        dispatch({
  ...
  // const key_id = "rzp_test_eyuWUoPChgfzBC";
  // const key_secret = "J4pAlk65GJZE4SgPt6PWzzin";
  // const OrderApi = "http://192.168.90.47:4001/api";
  ...
  console.log(key_id, key_secret, OrderApi, 'checking_all_env_file')
  ...
  const tbsamount =
    ...
    Number(tbsTotalTax) -
    Number(tbsdiscountamount).toFixed(2);
  ...
  console.log(tbsbasefare, 'tbs_base_fare')
  ...
  const OrderId_Generate = async () => {
    ...
    const requestBody = {
      amount: Number((tbsamount * 100).toFixed(2)),
      currency: 'INR',
      receipt: `receipt_${Date.now()}`,
      notes: {
        notes_key_1: 'bus booking',
        notes_key_2: 'bus booking2',
      },
      payment_capture: 1,
    };
  ...
  const RazorpayGateway = async () => {
    // setPayButton(true);
    // setRazorpayLoading(true);
    // console.log(tbsamount, "tbsamountntntntnt");
    const tbs_deal =
      Number(faredetails?.TotadultFare) * Number(tbs_discount / 100);
    if (!tbsamount) {
      // console.log("Please enter an amount");
    ...
    try {
      ...
      const beforepay = await BackUpData(
        "response?.TicketNo",
        generatedOrderId,
        "payment_id",
        "signature",
  ...
  console.log(passengerData, 'passenger_data')
  var options = {
    description: 'Credits towards consultation',
    image: 'https://i.imgur.com/3g7nmJC.jpg',
    currency: 'INR',
  ...
  const OfferItemsRow = ({ image, isSelected, onPress }) => (
    <View
      style={{
        marginVertical: 10,
      ...
      <TouchableOpacity
        ...
        style={{
          ...
          padding: 10,
          // borderWidth: 2,
          // borderColor: isSelected ? '#28a745' : '#ccc', // Green border if selected
          borderRadius: 10,
          // backgroundColor: isSelected ? '#e6f9ef' : '#fff', // Optional highlight
        }}>
        <Image
          source={{
            uri: `${api_crm_image}${image?.theme ? image?.theme : image?.background_image
          ...
          style={{ height: 100, width: 200, borderRadius: 8 }}
        />
        {console.log(
          `${api_crm_image}${image?.theme ? image?.theme : image?.background_image
          }`,
  ...
  useEffect(() => {
    if (confirmRefNo?.length > 0) {
      GetAvailableOffers(dispatch, emailInput, mobileInput);
    }
  }, [confirmRefNo]);
  ...
  const handleOfferValid = async values => {
    ...
    try {
      const response = await GetOfferValid(emailInput, mobileInput, values);
      console.log(response, 'got_response_offers');
      if (response?.data === true) {
        handleoffer(response?.details);
        setFinalDiscount(tbsdiscountamount);
      }
      // if (response?.data === true) {
      //     setFinalDiscount(tbsdiscountamount);
  ...
  const handleoffer = item => {
    console.log(item, 'handleoffers');
    setSelectValues(prev => {
      const isSelected = prev?.code === item.code;
      const newState = isSelected
        ? null
        : {
          value: item?.value ? item.value : item?.offer_value,
          Symbol: item?.symbol ? item.symbol : item?.value_symbol,
          code: promoCode,
        };
      ...
      setDiscount(prevDiscount => {
        ...
        if (item?.value_symbol?.includes('₹') || item?.symbol?.includes('₹')) {
          return Math.round(item?.value ? item?.value : item?.offer_value);
        } else {
          ...
          return Math.round(
            (Number(item?.value ? item?.value : item?.offer_value) / 100) *
            Number(amount),
          );
        }
      });
      ...
      {ticketLoader === true ? (
        <View
          ...
          <FastImage
            ...
            source={require('../assets/Loader/bus.gif')}
                    ...
                    <View
                      ...
                      {isJourneyExpand === true && (
                        <View>
                            ...
                            <View
                              ...
                              <View
                                ...
                                {Array.isArray(seatNumbers) &&
                                  ...
                                  chunkArray(
                                    seatNumbers,
                                    Math.ceil(seatNumbers.length / 2),
                                  ).map((row, index) => (
                                    <Text
                                      key={index}
                                      style={{
                          ...
                          <View
                            style={{ flexDirection: 'row', paddingBottom: 14 }}>
                            <View
                              style={{
                                flex: 1,
                                justifyContent: 'center',
                          ...
                          <View>
                            ...
                            <FlatList
                              ...
                              renderItem={({ item }) => (
                                <OfferItemsRow
                                  image={item}
                                  isSelected={item.id === selectedOfferId}
                                  onPress={() => {
                                    if (selectedOfferId === item.id) {
                                      ...
                                      if (mobileInput === '') {
                                        ...
                                        // Select and apply the offer
                                        setSelectedOfferId(item.id);
                                        setPromoCode(item.code);
                                        handleOfferValid(item.code);
                                      }
                                    }
                                  }}
                                />
                                  ...
                                  <TouchableOpacity
                                    style={[
                                      ...
                                      screenTheme === 'Luxury Coach'
                                        ...
                                        : {
                                          borderColor: tbsdiscountamount != null ? "#FF0000" : themecolor,
                                          borderWidth: 1.3,
                                        },
                                    ]}
                                    onPress={() => {
                                      if (mobileInput === '') {
                                        ...
                                        //    handleOfferValid
                                        // handleOfferValid(promoCode);
                                      }
                                      if (tbsdiscountamount != null) {
                                        // Log to ensure the onPress is being triggered correctly
                                        console.log('Removing offer...');

                                        // Deselect the selected offer
                                        setDiscount(null); // Deselect the offer
                                    ...
                                    <LinearGradient
                                      ...
                                      <Text
                                        ...
                                        {tbsdiscountamount != null ? 'Remove' : "Apply"}
                                      </Text>
                                    </LinearGradient>
                                  </TouchableOpacity>
                                </View>
                              ...
                              {/* <TouchableOpacity
                                ...
                                <Text
                                  style={{
                                    ...
                                    marginTop: 5, // Adjust this to reduce spacing
                                    marginLeft: -40,
                                  }}>
                                  Remove
                                </Text>
                              ...
                              <View
                                ...
                                <Text
                                  ...
                                  {`₹ ${(calculateDiscountedFare(
                                    ...
                                    Number(faredetails?.TotadultFare),
                                    tbs_discount,
                                  ) + Number(tbsTotalTax) - Number(tbsdiscountamount)).toFixed(2)}`}
