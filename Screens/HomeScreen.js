...
//   const [searchBus, setSearchBus] = useState(true)
...
//   const shimmerTranslateX = animation.interpolate({
//     inputRange: [0, 1],
//     outputRange: [-200, 200], // Use numeric values here (not strings)
//   });
...
//     inputRange: [0, 1],
//     outputRange: [0, -0.087 * 10000], // Adjust based on the image width or desired movement
//   });
...
//     inputRange: [0, 1],
//     outputRange: [0, -0.1308 * 10000], // Adjust based on the image width or desired movement
//   });
...
//   // useEffect(() => {
//   //   // Sequence of animations, one after another
//   //   Animated.sequence([
//   //     Animated.timing(doubleAnim, {
//   //       toValue: 1,
//   //       duration: 10000, // Duration of one full cycle (can be adjusted)
...
//   //     }),
//   //   ]).start();
//   // }, [doubleAnim, autoAnim, singleAnim]);

//   // // Smooth translation for each animation
//   // const doubleTranslateX = doubleAnim.interpolate({
//   //   inputRange: [0, 1],
//   //   outputRange: [0, 0.08 * 10000], // Adjust based on the image width or desired movement
//   // });

//   // const autoTranslateX = autoAnim.interpolate({
//   //   inputRange: [0, 1],
//   //   outputRange: [0, 0.05 * 10000], // Adjust based on the image width or desired movement
//   // });

//   // const singleTranslateX = singleAnim.interpolate({
//   //   inputRange: [0, 1],
//   //   outputRange: [0, 0.2 * 10000], // Adjust based on the image width or desired movement
//   // });

//   // const [collapsed, setCollapsed] = useState(true); // State to track collapsed/expanded state
//   // const scrollY = useRef(new Animated.Value(0)).current; // Animated value to track scroll position
//   // const animatedHeight = useRef(new Animated.Value(170)).current; // Initial height of the first view tag

//   // const handleHomeScroll = Animated.event(
//   //   [{ nativeEvent: { contentOffset: { y: scrollY } } }],
//   //   { useNativeDriver: false }
//   // );

//   // // Expand the first view when the button is pressed
...
//   //   } else {
//   //     Animated.spring(animatedHeight, {
//   //       toValue: 170, // 42.5% of the screen height or any value you want
//   //       useNativeDriver: false,
//   //     }).start();
//   //   }
//   // };
...
//   // console.log(isReduced, 'is_reduced')
//   // Get screen height to set percentages for heights dynamically
...
//   const handleHoScroll = (event) => {
//     const contentOffsetY = event.nativeEvent.contentOffset.y;

//     // Trigger the sheet when the scroll position is beyond a threshold
//     if (contentOffsetY > 150 && !hasScrolled) {
//       setHasScrolled(true);  // Set state to prevent triggering multiple times
...
//       {/* {
//           isScrollingDown ?
//             <SearchBus isScrollingDown={isScrollingDown} setIsScrollingDown={setIsScrollingDown} navigation={navigation} />
//             : */}
...
//             <LinearGradient
//               colors={['#007fe7d7', '#1f4b7f', '#007fe7d7']}
//               start={{ x: 0, y: 0 }}
//               end={{ x: 1, y: 0 }}
...
//             // source={require('./assets/Theme/Sky/General_Sky.png')}
//             // source={{ uri: `${apiCrmImage}${currentTheme?.background}` }}
//             style={[styles.background_theme, { width, height }]} // Dynamically set width and height to screen size
//           >
...
//               style={{ height: 240, width: '110%', resizeMode: 'contain' }}
//             />
//             <Image
//               source={currentTheme?.building
//                 ? { uri: `${apiCrmImage}${currentTheme.building}` }
...
//             />
//             {/* <Image
//             source={require('./assets/Theme/Buildings/bgimage.png')}
//             style={{ height: 220, width: '70%', resizeMode: 'contain' }}
//           />
//           <Image
//             source={require('./assets/Theme/Buildings/bgimage.png')}
//             style={{ height: 220, width: '70%', resizeMode: 'contain' }}
...
//           >
//             <Image
//               // source={{ uri: `${apiCrmImage}${currentTheme?.road}` }}
...
//             {/* <Image
//             source={{ uri: `${apiCrmImage}${currentTheme?.road}` }}
//             style={{ height: 135, width: '82%', resizeMode: 'contain' }}
//           /> */}
//             {/* <Image
//             source={require('./assets/Theme/Roads/Full3.png')}
//             style={{ height: 107.5, width: '62.5%', resizeMode: 'contain' }}
//           />
//           <Image
//             source={require('./assets/Theme/Roads/Full3.png')}
//             style={{ height: 107.5, width: '62.5%', resizeMode: 'contain' }}
...
//           <Image
//             source={require('./assets/Theme/Roads/Full3.png')}
//             style={{ height: 107.5, width: '62%', resizeMode: 'contain' }}
//           /> */}
//           </Animated.View>
//           <Animated.View
//             style={{
...
//               style={{ height: 70, width: '65%', resizeMode: 'contain' }}
//             />
//           </Animated.View>
//           <Animated.View
//             style={{
...
//         <SearchBus isReduced={isReduced} setIsReduced={setIsReduced} />
//       </SafeAreaView>
//       {/* } */}
//     </>
//   );
...
//     height: '60%', // Define the height here
//     backgroundColor: 'white',
//     // padding: 20,
//     // borderRadius: 10,
//     // justifyContent: 'center',
...
// // decelerationRate='normal' // Adjust this to 'fast' or 'normal' for more sensitivity, 'slow' for less.
// // scrollEventThrottle={1000}  // Lower value increases sensitivity, higher reduces it.
...
// //           </View>
// //           <View>
// //             <Text style={{ position: 'absolute', top: -37, right: 110, color: '#1F487C', fontWeight: 700, backgroundColor: '#E5FFF1', fontSize: 20 }}>
// //               {` Journey Place `}
// //             </Text>
// //             {/* marginTop: 10,
// //       color: '#1F487C',
...
// //         </View>
// //       </View>
// //       <View style={{ flexDirection: 'row', gap: 5, margin: 10, marginVertical: 15 }}>
...
// import HeadArrow from './assets/HeadArrow';

import VehicleIcone from './assets/VehicleIcone';

import PlaceIcon from './assets/PlaceIcon';

import ArrowHeader from './assets/ArrowHeader';
...
const data = [
  {
    from_Id: '3',
    from_station_name: 'Hyderabad',
    from_state: 'Telengana',
    to_Id: '5',
    to_station_name: 'Vijayawada',
    distance: '332 Km',
  },

  {
    from_Id: '4',
    from_station_name: 'Mumbai',
...

  {
    ...
    to_Id: '795',
    to_station_name: 'Tiruchirapalli',
    distance: '574 Km',
  },
];
...
const HomeScreen = ({navigation}) => {
  ...
  const top_bus_route = useSelector(state =>
    state?.productReducer?.top_route_list.slice(0, 3),
  );
  ...
  const currentTheme = useSelector(
    state => state?.productReducer?.current_theme,
  );
  ...
  const renderDateItem = ({item, index}) => {
    ...
    const isSelectingScrollDate =
      item.formattedDate === selectingScrollDate.formattedDate;
    ...
    return (
      <TouchableOpacity
        ...
        style={[
          styles.dayContainer,
          isSelected && styles.selectedDayContainer,
          isSelectingScrollDate && styles.selectingScrollDateContainer,
        ]}>
        <Text
          style={[
            styles.dayName,
            isSelected && styles.selectedText,
            isSelectingScrollDate && styles.selectingScrollDateText,
          ]}>
          {item.dayName}
        </Text>
  ...
  useEffect(() => {
    ...
    const todayIndex = days.findIndex(
      day => day.formattedDate === formattedToday,
    );
  ...
  const handleDateSelect = date => {
    ...
    const selectedIndex = days.findIndex(
      day => day.formattedDate === formatDate(date),
    );
          ...
          <View
            ...
            <Text style={{color: '#1F487C', fontSize: 15, fontWeight: '500'}}>
              {item?.from?.charAt(0).toUpperCase() +
                item?.from?.slice(1).toLowerCase()}
            </Text>
          </View>

          <View style={{flex: 1, marginLeft: 10, backgroundColor: 'white'}}>
            <Svg style={{flex: 1}}>
              <LineDotIcone width="150%" height="120%" />
            </Svg>
            {/* <Svg>
              <HeadArrow/>
            </Svg> */}
          ...
          <View
            ...
            <Text style={{color: '#1F487C', fontSize: 15, fontWeight: '500'}}>
              {item?.to?.charAt(0).toUpperCase() +
                item?.to?.slice(1).toLowerCase()}
            </Text>
          </View>
        </View>

        <View
          style={{ marginLeft:245,position:"absolute",marginTop:34}}>
          <ArrowHeader height="15" width="15" />
        </View>
    ...
    <SafeAreaView style={styles.safeAreaView} edges={['right', 'left']}>
      ...
      <View
        style={[
          ...
          {height: isReduced ? screenHeight * 0.05 : screenHeight * 0.4},
        ]}>
        {/* {!lazyloading ?
                  ...
                  <View style={{flexDirection: 'row'}}>
                    ...
                    <View>
                      <TouchableOpacity
                        ...
                        onPress={() => setIsReduced(!isReduced)}>
                        {isReduced === false ? (
                          <Image
                            source={require('./assets/navigateUp.png')}
                            style={{
              ...
              <View>
                ...
                {isUserPlans && (
                  <View
                    style={{
                      height: 100,
                      width: '100%', // Decrease the height as needed
                      paddingHorizontal: 0,
                      paddingVertical: 0,
