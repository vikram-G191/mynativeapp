...
const LoginScreenReferal = ({ navigation }) => {
            ...
            >
                <Formik initialValues={values} validationSchema={validationSchema} enableReinitialize
                    ...
                    onSubmit={(values, formikActions) => {
                        ...
                        if ((values?.phone.length === 10) && values?.referal) {
                            console.log('----')
                            navigation.navigate('OTPScreen')
                        }
                    }}
                        ...
                        return (
                            <View style={{ flex: 1, width: '100%', height: '100%', }}>
                                ...
                                <View style={{ margin: 20, }}>
                                    ...
                                    <View style={{ flexDirection: 'row', borderWidth: 1, borderColor: '#ccc', marginTop: 10, backgroundColor: '#fff', borderRadius: 10, gap: 5 }}>
                                        <TextInput
                                            style={styles.textInput}
...
export default LoginScreenReferal;
